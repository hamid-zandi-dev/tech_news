...
class GetArticlesUsecase extends UseCaseStream<
    Either<Failure, List<ArticleModel>>, GetArticlesParams> {
...
class GetArticlesParams {
  ...
  static GetArticlesParams forQuery(
      String query, String to, String from, int page, int pageSize) {
