...
import 'package:tech_news/features/article/presentation/bloc/article_list_status.dart';
...
class _ArticleListScreenState extends State<ArticleListScreen>
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          return ArticleItemWidget(
            ...
            onClickListener: () {
              _handleArticleClickListener(list[index]);
            },
          );
        },
  ...
  void _handleArticleClickListener(ArticleModel article) {
    Navigator.of(context, rootNavigator: true).pushNamed(
        AppRoutes.articleDetailsRoute,
        arguments: {ArticleDetailsScreen.articleModel: article});
  }
