...
void main() {
  group('ArticleModel Tests', () {
    ...
    test('should maintain immutability of most properties', () {
      // These properties should be final and immutable
      // Note: In Dart, final fields cannot be reassigned, so we test that they maintain their values
      expect(articleModel.source.id, equals("test-source-id"));
      expect(articleModel.title, equals("Test Article Title"));
      expect(articleModel.author, equals("Test Author"));
      expect(articleModel.description, equals("Test article description"));
      expect(articleModel.url, equals("https://example.com/article"));
    ...
    test('should allow modification of queryTitle only', () {
      // queryTitle should be mutable
      expect(() => articleModel.queryTitle = "Tesla", returnsNormally);
      expect(articleModel.queryTitle, equals("Tesla"));
    });
